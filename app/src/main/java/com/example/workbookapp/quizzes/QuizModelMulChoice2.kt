...
class QuizModelMulChoice2 : AppCompatActivity() {

    var dbHandler : DatabaseHelper = DatabaseHelper(this)
    var questionList : List<QuizzesMulChoice2Model> = ArrayList<QuizzesMulChoice2Model>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_quiz_model_mul_choice2)
    ...
    private fun fetchList(){
        questionList = dbHandler!!.getALlQuizModel2(quiz_name.toString(), topic.toString())
    }
