...
class SyntaxActivityFour : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textView.apply {
            text = getString(R.string.syntax_four_instruction) // Get the text from strings.xml
        }
        ...
        oneOne.setOnClickListener {
            ...
            val dialogBinding = layoutInflater.inflate(R.layout.syntax_four_one, null)
            ...
            textViewContent.apply {
                text = getString(R.string.syntax_four_one)
            }
        ...
        oneTwo.setOnClickListener {
            ...
            val dialogBinding = layoutInflater.inflate(R.layout.syntax_four_two, null)
            ...
            val textViewContent = dialogBinding.findViewById<TextView>(R.id.textViewContent)
            textViewContent.apply {
                text = getString(R.string.syntax_four_two)
            }
        ...
        oneThree.setOnClickListener {
            ...
            val dialogBinding = layoutInflater.inflate(R.layout.syntax_four_three, null)
            ...
            val textViewContent = dialogBinding.findViewById<TextView>(R.id.textViewContent)
            textViewContent.apply {
                text = getString(R.string.syntax_four_three)
            }
        ...
        oneFour.setOnClickListener {
            val dialogBinding = layoutInflater.inflate(R.layout.syntax_four_four, null)
            ...
            val textViewContent = dialogBinding.findViewById<TextView>(R.id.textViewContent)
            textViewContent.apply {
                text = getString(R.string.syntax_four_four)
            }
        ...
        oneFive.setOnClickListener {
            val dialogBinding = layoutInflater.inflate(R.layout.syntax_four_five, null)
            ...
            val textViewContent = dialogBinding.findViewById<TextView>(R.id.textViewContent)
            textViewContent.apply {
                text = getString(R.string.syntax_four_five)
            }
