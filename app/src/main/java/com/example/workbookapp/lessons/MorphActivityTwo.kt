...
class MorphActivityTwo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        oneOne.setOnClickListener {
            ...
            val dialogBinding = layoutInflater.inflate(R.layout.morph_two_1, null)
        ...
        oneTwo.setOnClickListener {
            ...
            val dialogBinding = layoutInflater.inflate(R.layout.morph_two_2, null)
        ...
        oneThree.setOnClickListener {
            ...
            val dialogBinding = layoutInflater.inflate(R.layout.morph_two_3, null)
